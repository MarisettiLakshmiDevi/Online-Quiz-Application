const allTopics = {
  "Basic Computers": [
    { question: "What does CPU stand for?", options: ["Central Processing Unit", "Computer Personal Unit", "Central Process Utility", "Control Processing Unit"], answer: "Central Processing Unit" },
    { question: "Which device is used for permanent data storage?", options: ["RAM", "ROM", "Hard Disk", "Cache"], answer: "Hard Disk" },
    { question: "Which of the following is an input device?", options: ["Monitor", "Keyboard", "Printer", "Speaker"], answer: "Keyboard" },
